...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void confirmOtp() throws JSONException {
        ...
        resendotp = (TextView) confirmDialog.findViewById(R.id.resend_otp);
        ...
        resendotp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, "You Click on Resend Otp", Toast.LENGTH_LONG).show();
                resendOtp();
            }
        });
    ...
    private void resendOtp() {
        //Creating an string request
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.RESEND_URL,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        //if the server response is success
