...
public class ListViewAdapter extends BaseAdapter {
	...
	public ListViewAdapter(Context context, List<WorldPopulation> worldpopulationlist) {
		...
		Log.e( "ListViewAdapter: ", arraylist+"");
		Log.e( "ListViewAdapter: ", worldpopulationlist+"");
	}
	...
	public View getView(final int position, View view, ViewGroup parent) {
		...
		Log.e( "onBindViewHolder: ", worldpopulationlist.get(position).getRank());
		Log.e( "onBindViewHolder: ", worldpopulationlist.get(position).getCountry());
	...
	public void filter(String charText) {
		...
		Log.e( "filter:1 ", worldpopulationlist+"");
		if (charText.length() == 0) {
			worldpopulationlist.addAll(arraylist);
			Log.e( "filter:2 ", worldpopulationlist+"");
			Log.e( "filter:3 ", arraylist+"");
		} 
		else 
		{
			for (WorldPopulation wp : arraylist) 
			{
				if (wp.getCountry().toLowerCase(Locale.getDefault()).contains(charText)) 
				{
					...
					Log.e( "filter:5 ", worldpopulationlist+"");
				}
			}
		}
